...
public abstract class FacetFactory {
        ...
        switch (type) {
            ...
            case LEGAL_FORM:
                return new FacetInfo("by legal form",
                                     getFacetItemList(new String[] {"Podnikateæ-fyzick· osoba ...",
                                                                    "SpoloËnosù s ruËenÌm obmedzen˝m",
                                                                    "Zdruûenie (zv‰z, spolok, spoloËnosù, klub ai.)",
                                                                    "Akciov· spoloËnosù",
                                                                    "inÈ"},
                                                      new String[] {"legal_form:Podnika*",
                                                                    ...
                                                                    "legal_form:Zdru*",
                                                                    "legal_form:Akciov*",
                                                                    "-legal_form:(Podnika* SpoloËno* Zdru* Akciov*)"},
                                                      facetItems));
            case SEAT:
                return new FacetInfo("by seat",
                                     getFacetItemList(new String[]{"Bansk· Bystrica",
                                                                   "Bratislava",
                                                                   "Koöice",
                                                                   "Nitra",
                                                                   "Preöov",
    ...
    public static List<FacetItem> getDefaultFacetItemList(Map<String, Integer> countMapping) {
        return getFacetItemList(new String[] {"organiz·cie",
                                              "obstar·vanie",
                                              "sponzori politick˝ch str·n"},
                                new String[] {"type:ORG*",
                                              "type:PRO*",
                                              "type:POL*"},
                                countMapping);
